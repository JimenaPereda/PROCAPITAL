...
var initAutoRemoveContainer = true;
var initShow = true;
...
var usePortal = function usePortal(_temp) {
  var _ref = _temp === void 0 ? {} : _temp,
      ...
      autoRemoveContainer = _ref$autoRemoveContai === void 0 ? initAutoRemoveContainer : _ref$autoRemoveContai,
      _ref$defaultShow = _ref.defaultShow,
      defaultShow = _ref$defaultShow === void 0 ? initShow : _ref$defaultShow,
  ...
  var Portal = useCallback(createPortal(containerId, autoRemoveContainer, !internalShowHide || isShow, clickOutsideToHide ? handleHide : undefined, escToHide ? handleHide : undefined), [internalShowHide, isShow]);
  return {
    Portal: Portal,
    isShow: isShow,
    show: show,
...
export { defaultContainerId, initAutoRemoveContainer, initShow };
